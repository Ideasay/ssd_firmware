...
void xdma_usr_irq_vector_set(u16 irq_num, u16 vec_num)
{
    ...
    XDMA_PRINT("IRQ Vector addr: 0x%x, rd_data: 0x%x, wr_data: 0x%x\n\r", addr, data, wr_data);
	...
	for (int i = 0; i < 4*N; i++){
		...
		switch(i%4){
				case 0: XDMA_PRINT("MSIX Vector Lower Address: 0x%x, ", value);
					break;
				case 1: XDMA_PRINT("Upper Address: 0x%x, ", value);
					break;
				case 2: XDMA_PRINT("Data: 0x%x, ", value);
					break;
				case 3: XDMA_PRINT("Control: 0x%x\n\r", value);
					break;
			}
	}
#ifdef XDMA_DEBUG
	u32 value = Xil_In32(XDMA_REG_BASEADDR + XDMA_MSIX_PBA_ADDR);
	XDMA_PRINT("MSIX PBA: 0x%x\n\r", value);
#endif
}
...
u64 get_asq_dsc_dst_addr()
{
	u32 value_l32 = Xil_In32(USER_REG_BASEADDR + ADDR_ASQ_DSC_DST_ADDRL);
	u32 value_h32 = Xil_In32(USER_REG_BASEADDR + ADDR_ASQ_DSC_DST_ADDRH);
	return ((u64)value_h32 << 32) | value_l32;
}
...
u64 get_acq_dsc_src_addr()
{
	u32 value_l32 = Xil_In32(USER_REG_BASEADDR + ADDR_ACQ_DSC_SRC_ADDRL);
	u32 value_h32 = Xil_In32(USER_REG_BASEADDR + ADDR_ACQ_DSC_SRC_ADDRH);
	return ((u64)value_h32 << 32) | value_l32;
}
...
u32 get_io0_sq_buf_wptr()
{
	return Xil_In32(USER_REG_BASEADDR + ADDR_IOSQ_BUF_WPTR);
}

u32 get_io0_cq_buf_rptr()
{
	return Xil_In32(USER_REG_BASEADDR + ADDR_IOCQ_BUF_RPTR);
}
...
void set_asq_dsc_dst_addr(u64 value)
{
	Xil_Out32((USER_REG_BASEADDR + ADDR_ASQ_DSC_DST_ADDRL), (u32)value);
	Xil_Out32((USER_REG_BASEADDR + ADDR_ASQ_DSC_DST_ADDRH), (u32)(value >> 32));
}
...
void set_acq_dsc_src_addr(u64 value)
{
	Xil_Out32((USER_REG_BASEADDR + ADDR_ACQ_DSC_SRC_ADDRL), (u32)value);
	Xil_Out32((USER_REG_BASEADDR + ADDR_ACQ_DSC_SRC_ADDRH), (u32)(value >> 32));
}
...
void set_ioh2cD_dsc_ctl(u32 value)
{
	Xil_Out32((USER_REG_BASEADDR + ADDR_IOH2CD_DSC_CTL), value);
}

void set_ioh2cD_dsc_len(u32 value)
{
	Xil_Out32((USER_REG_BASEADDR + ADDR_IOH2CD_DSC_LEN), value);
}

void set_ioh2cD_dsc_addr(u64 value)
{
	Xil_Out32((USER_REG_BASEADDR + ADDR_IOH2CD_DSC_ADDRL), (u32)value);
	Xil_Out32((USER_REG_BASEADDR + ADDR_IOH2CD_DSC_ADDRH), (u32)(value >> 32));
}

void set_ioh2cD_dsc_dst_addr(u64 value)
{
	Xil_Out32((USER_REG_BASEADDR + ADDR_IOH2CD_DSC_DST_ADDRL), (u32)value);
	Xil_Out32((USER_REG_BASEADDR + ADDR_IOH2CD_DSC_DST_ADDRH), (u32)(value >> 32));
}

void set_ioh2cP_dsc_ctl(u32 value)
{
	Xil_Out32((USER_REG_BASEADDR + ADDR_IOH2CP_DSC_CTL), value);
}

void set_ioh2cP_dsc_len(u32 value)
{
	Xil_Out32((USER_REG_BASEADDR + ADDR_IOH2CP_DSC_LEN), value);
}

void set_ioh2cP_dsc_addr(u64 value)
{
	Xil_Out32((USER_REG_BASEADDR + ADDR_IOH2CP_DSC_ADDRL), (u32)value);
	Xil_Out32((USER_REG_BASEADDR + ADDR_IOH2CP_DSC_ADDRH), (u32)(value >> 32));
}

void set_ioh2cP_dsc_dst_addr(u64 value)
{
	Xil_Out32((USER_REG_BASEADDR + ADDR_IOH2CP_DSC_DST_ADDRL), (u32)value);
	Xil_Out32((USER_REG_BASEADDR + ADDR_IOH2CP_DSC_DST_ADDRH), (u32)(value >> 32));
}

void set_ioc2hD_dsc_ctl(u32 value)
{
	Xil_Out32((USER_REG_BASEADDR + ADDR_IOC2HD_DSC_CTL), value);
}

void set_ioc2hD_dsc_len(u32 value)
{
	Xil_Out32((USER_REG_BASEADDR + ADDR_IOC2HD_DSC_LEN), value);
}

void set_ioc2hD_dsc_addr(u64 value)
{
	Xil_Out32((USER_REG_BASEADDR + ADDR_IOC2HD_DSC_ADDRL), (u32)value);
	Xil_Out32((USER_REG_BASEADDR + ADDR_IOC2HD_DSC_ADDRH), (u32)(value >> 32));
}

void set_ioc2hD_dsc_src_addr(u64 value)
{
	Xil_Out32((USER_REG_BASEADDR + ADDR_IOC2HD_DSC_SRC_ADDRL), (u32)value);
	Xil_Out32((USER_REG_BASEADDR + ADDR_IOC2HD_DSC_SRC_ADDRH), (u32)(value >> 32));
}
u32 get_io_dma_status()
{
	return Xil_In32(USER_REG_BASEADDR + ADDR_IODMA_DONE);
}
